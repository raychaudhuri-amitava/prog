...
int main(int argc,char**argv){
   ...
   { for (num = (((num)/10000000000)%10 + ((num)/1000000000)%10 + ((num)/100000000)%10 + ((num)/10000000)%10 + ((num)/1000000)%10 + ((num)/100000)%10 + ((num)/10000)%10 + ((num)/1000)%10 + ((num)/100)%10 + ((num)/10)%10 + ((num)/1)%10); num > 9; num = (((num)/10000000000)%10 + ((num)/1000000000)%10 + ((num)/100000000)%10 + ((num)/10000000)%10 + ((num)/1000000)%10 + ((num)/100000)%10 + ((num)/10000)%10 + ((num)/1000)%10 + ((num)/100)%10 + ((num)/10)%10 + ((num)/1)%10));};
